...
pub use defs::{
    ...
    editor::{
        ...
        ToggleInlineBlame, ToggleMinimap, ToggleRelativeLineNumbers, ToggleReplaceInGlobalSearch,
        ToggleTabBar, TriggerCompletion, TrimSelections, Undo, UnfoldAll, UnfoldAtCursor,
