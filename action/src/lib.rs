...
pub use defs::{
    ...
    editor::{
        ...
        SelectPrevSibling, SelectRegister, SelectTextobjectAround, SelectTextobjectInner, SetMark,
        ShellInsertOutput, ShellKeepPipe, ShellPipe, ShellPipeTo, ShrinkSelection, SplitSelection,
