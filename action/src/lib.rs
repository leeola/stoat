...
pub use defs::{
    ...
    editor::{
        ...
        PasteClipboardAfter, PasteClipboardBefore, Redo, RemovePrimarySelection, RepeatLastMotion,
        ...
        SelectPrevSibling, SelectRegister, SetMark, ShrinkSelection, SurroundAdd, SurroundDelete,
