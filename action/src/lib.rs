...
pub use defs::{
    ...
    editor::{
        ...
        CloseBuffer, CollapseSelection, Decrement, DeleteSelection, ExpandSelection, ExtendDown,
        ...
        Redo, RemovePrimarySelection, RemoveSelections, RepeatLastMotion, ReplaceChar, ReplayMacro,
        RotateSelectionsBackward, RotateSelectionsForward, SaveBuffer, SaveSelection, ScrollDown,
        ScrollUp, SearchNext, SearchPrev, SelectAll, SelectLineBelow, SelectNextSibling,
        SelectPrevSibling, SelectRegister, SetMark, ShellInsertOutput, ShellKeepPipe, ShellPipe,
        ShellPipeTo, ShrinkSelection, SplitSelection, SurroundAdd, SurroundDelete, SurroundReplace,
