...
pub use defs::{
    ...
    editor::{
        ...
        GotoWord, HalfPageDown, HalfPageUp, Increment, IndentSelection, JumpBackward, JumpForward,
        ...
        MovePrevWordStart, MoveRight, MoveUp, OpenAbove, OpenBelow, OpenReverseSearchInput,
        OpenSearchInput, PageDown, PageUp, Redo, RemovePrimarySelection, RepeatLastMotion,
        ReplaceChar, RotateSelectionsBackward, RotateSelectionsForward, SaveSelection, ScrollDown,
        ScrollUp, SearchNext, SearchPrev, SelectAll, SelectLineBelow, SelectNextSibling,
        SelectPrevSibling, SetMark, ShrinkSelection, SurroundAdd, SurroundDelete, SurroundReplace,
