...
pub use defs::{
    ...
    editor::{
        ...
        GotoPrevParagraph, GotoWindowBottom, GotoWindowCenter, GotoWindowTop, HalfPageDown,
        HalfPageUp, Increment, IndentSelection, JumpBackward, JumpForward, KeepPrimarySelection,
