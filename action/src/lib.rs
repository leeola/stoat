...
pub use defs::{
    ...
    editor::{
        ...
        OpenJumplistPicker, OpenReverseSearchInput, OpenSearchInput, PageDown, PageUp, PasteAfter,
        PasteBefore, PasteClipboardAfter, PasteClipboardBefore, Redo, RemovePrimarySelection,
