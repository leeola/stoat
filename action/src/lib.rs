...
pub use defs::{
    ...
    editor::{
        ...
        ExtendUp, FlipSelections, GotoFileStart, GotoFirstNonwhitespace, GotoLastLine, GotoLineEnd,
        GotoLineNumber, GotoLineStart, GotoNextChange, GotoPrevChange, GotoWindowBottom,
        GotoWindowCenter, GotoWindowTop, HalfPageDown, HalfPageUp, IndentSelection, JumpBackward,
        JumpForward, KeepPrimarySelection, MoveDown, MoveLeft, MoveNextWordEnd, MoveNextWordStart,
        MoveParentNodeEnd, MoveParentNodeStart, MovePrevWordEnd, MovePrevWordStart, MoveRight,
        MoveUp, PageDown, PageUp, Redo, RotateSelectionsBackward, RotateSelectionsForward,
