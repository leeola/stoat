...
pub use defs::{
    ...
    editor::{
        ...
        DeleteSelection, ExtendDown, ExtendLeft, ExtendNextWordEnd, ExtendNextWordStart,
        ExtendPrevWordEnd, ExtendPrevWordStart, ExtendRight, ExtendToFileStart, ExtendToLastLine,
        ExtendToLineEnd, ExtendToLineStart, ExtendUp, FlipSelections, GotoFileStart,
        GotoFirstNonwhitespace, GotoLastLine, GotoLineEnd, GotoLineStart, GotoWindowBottom,
        GotoWindowCenter, GotoWindowTop, HalfPageDown, HalfPageUp, KeepPrimarySelection, MoveDown,
