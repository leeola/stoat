...
pub use defs::{
    ...
    editor::{
        ...
        ExtendFindNextChar, ExtendFindPrevChar, ExtendLeft, ExtendNextWordEnd, ExtendNextWordStart,
        ExtendPrevWordEnd, ExtendPrevWordStart, ExtendRight, ExtendTillNextChar,
        ...
        IndentSelection, JumpBackward, JumpForward, KeepPrimarySelection, MatchBrackets, MoveDown,
