...
pub use defs::{
    ...
    editor::{
        ...
        GotoLineNumber, GotoLineStart, GotoMark, GotoMarkExact, GotoNextClass, GotoNextFunction,
        GotoNextHunk, GotoNextParagraph, GotoPrevClass, GotoPrevFunction, GotoPrevHunk,
        ...
        ToggleMinimap, ToggleTabBar, TriggerCompletion, TrimSelections, Undo, UnindentSelection,
    ...
    review::{
        ...
        ReviewLineSelectToggle, ReviewNextChunk, ReviewNextUnreviewedHunk, ReviewPrevChunk,
