use crate::{
    defs::{
        ...
        editor::{
            ...
            TillNextChar, TillPrevChar, ToggleBlockComments, ToggleComments, ToggleInlayHints,
            ToggleLineComments, ToggleLspStatus, ToggleSyntaxHighlight, TrailClear, TrailNext,
...
fn init() -> HashMap<&'static str, RegistryEntry> {
    ...
    add(GotoFirstDiagnostic::DEF, |_| {
        Ok(Box::new(GotoFirstDiagnostic))
    });
    ...
    add(ExtendLineBelow::DEF, |_| Ok(Box::new(ExtendLineBelow)));
