...
//! 2. Query [`BufferDiff`](stoat_v4::git_diff::BufferDiff) for hunks
...
//! - [`BufferDiff`](stoat_v4::git_diff::BufferDiff) - Source of diff data

use gpui::{point, px, size, Bounds, Corners, Pixels, Point};
use std::ops::Range;
use stoat_v4::git_diff::{BufferDiff, DiffHunkStatus};
