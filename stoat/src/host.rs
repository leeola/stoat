...
pub use clipboard::{
    clipboard_copy, osc52_should_emit, ClipboardHost, ClipboardKind, NoopClipboard,
};
#[cfg(test)]
pub use fake::{
...
pub use local::{LocalClipboard, LocalGit, LocalLsp, LocalTerminalHost, LspTranscript};
