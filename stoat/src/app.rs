...
mod tests {
    ...
    use crate::{
        ...
        display_map::{
            highlights::{HighlightStyleId, HighlightStyleInterner},
            DisplayPoint,
        },
        host::FsEventKind,
    ...
    fn detach_emits_window_open_and_reattach_emits_window_close() {
        ...
        apc_emit::emit_windows(&mut h.stoat);
    ...
    fn editor_pool_pane_region_excludes_the_minimap_strip() {
        ...
        let (_, _, region) = apc_emit::editor_pool_panes(&h.stoat)[0];
    ...
    fn no_pool_pane_when_pane_is_not_an_editor() {
        ...
        assert!(apc_emit::editor_pool_panes(&h.stoat).is_empty());
    }
    ...
    fn a_conflict_pane_fills_with_the_three_column_body() {
        ...
        let (_, _, region) = apc_emit::editor_pool_panes(&h.stoat)
            .into_iter()
            .next()
    ...
    fn diff_view_click_maps_into_the_right_column() {
        ...
        assert_eq!(
            h.stoat.editor_screen_to_offset(editor_id, area, 70, 0),
            Some(2),
    ...
    fn quitting_hands_the_terminal_its_own_defaults_back() {
        ...
        apc_emit::emit_reset_default_colors(&h.stoat);
