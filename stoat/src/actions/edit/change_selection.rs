...
impl Stoat {
    /// Delete text within each selection and enter insert mode.
    pub fn change_selection(&mut self, cx: &mut Context<Self>) {
...
mod tests {
    ...
    #[gpui::test]
    fn changes_selected_text(cx: &mut TestAppContext) {
