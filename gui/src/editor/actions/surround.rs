...
//!   the canonical pair from [`stoat::action_handlers::surround::surround_pair_for`].
//!
...
//!   pair via [`stoat::action_handlers::surround::find_surround_pair`], which consults the buffer's
