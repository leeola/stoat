...
pub use movement::{
    ...
    find_number_seeking, next_long_word_end_range, next_long_word_start_range, next_word_end,
    next_word_end_range, next_word_start_range, prev_long_word_end_range,
