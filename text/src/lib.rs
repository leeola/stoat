...
pub use movement::{
    categorize_char, compute_number_delta, find_decimal_number_at, find_decimal_number_seeking,
    find_number_at, find_number_seeking, next_long_word_end, next_long_word_start, next_word_end,
    next_word_start, prev_long_word_end, prev_long_word_start, prev_word_end, prev_word_start,
    word_move_range, word_selection_offsets, CharCategory, NumberKind, NumberMatch, WordTarget,
};
